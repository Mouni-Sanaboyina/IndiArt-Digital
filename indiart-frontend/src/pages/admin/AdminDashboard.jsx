                    ...
                    <tr key={product._id} className="hover:bg-[#003459]/40 transition">
                      ...
                      <td className="p-4">
                        <div className="flex gap-2 items-center">
                          <label className={`cursor-pointer text-xs font-semibold px-3 py-1 rounded-lg border transition ${uploadingId === product._id ? 'opacity-50' : 'border-[#FFA500]/60 text-[#FFA500] hover:bg-[#FFA500]/10'}`}>
